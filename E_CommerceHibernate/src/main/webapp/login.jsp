...
<html lang="en">
   ...
   <body class="main-layout">
    ...
    <div class="layout_padding contact_section">
    	<div class="container">
    		<h1 class="new_text"><strong>Login Here</strong></h1>
    	</div>
                       ...
                       <div class="container">
                          ...
                          <span class="text-danger">${err}</span>
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Username" name="email">
                            </div>
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Password" name="pass">
                            </div>
                            <div class="send_btn">
                       <input type="submit" class="main_bt" value="Login">
                       
                       </div> 
                          </form>
                          <br>
                          <div class="send_btn">
                           <a href="registration.jsp"><button class="main_bt">SingUp</button></a>
                          </div> 
                       </div>     
                    </div>
    		</div>
