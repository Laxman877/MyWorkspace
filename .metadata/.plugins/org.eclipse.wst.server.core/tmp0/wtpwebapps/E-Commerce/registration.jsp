...
<html lang="en">
   ...
   <body class="main-layout">
    ...
    <div class="collection_text">Registration</div>
    <div class="layout_padding contact_section">
    	<div class="container">
    		<h1 class="new_text"><strong>Register Here</strong></h1>
    	</div>
                       ...
                       <span class="text-danger">${warn}</span>
                          <form action="user_reg">
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Name" name="cname" id="cname">
                              <span id="cnameE" class="text-danger">${cnameE}</span>
                            </div>
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Mobile Number" name="mobile" id="mobile">
                              <span id="mobileE" class="text-danger">${mobileE}</span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Password" name="password" id="password">
                              <span id="passwordE" class="text-danger">${passwordE}</span>
                            </div>
                        
                       </div> 
                       <div class="send_btn">
                       <input type="submit" class="main_bt" value="Sign Up">
                        <button class="main_bt"><a href="login.jsp">Login</a></button>
                       </div>                   
                    </div>
                      </form>
    		</div>
