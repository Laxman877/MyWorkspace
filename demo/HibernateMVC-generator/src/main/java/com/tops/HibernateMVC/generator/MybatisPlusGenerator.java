...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.tops";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/HibernateMVC-model"),
        mapper("/HibernateMVC-dao"),
        mapperxml("/HibernateMVC-web"),
        service("/HibernateMVC-service"),
        web("/HibernateMVC-web"),
        ;
